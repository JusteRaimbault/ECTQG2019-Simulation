...
\begin{small}
e.g. mail of Bruce Edmonds (emblematic figure of social simulation) on the SIMSOC mailing list, on the 16\textsuperscript{th} th of May 2019.
\begin{displayquote}
Dear Colleagues,
...
\textbf{Success stories: } epidemiology \cite{arduin2018modelisation}, ecology \cite{lavallee2019stochastic}, planning \cite{brasebin2017apports}, urban science \cite{raimbault2018indirect}
...
\begin{center}
    \includegraphics[width=0.7\textwidth]{figures/exmodelobanner.png}
\end{center}
...
\textit{Study of submodels to foster diverse questions and approaches}



\textit{Comparison of the ABM with alternative ontologies}
% alternative formalism plutôt que ontology ? (pour parler de l'ODE

Regimes of ABM compared to ODE patterns 
...
\bigskip 
Possibly :  model code modification
...
Expected benefits :
\begin{itemize}
    \item \textbf{Methods and approach dissemination}
    \item \small{OpenMOLE visibility improvement} %à voir si on veut promouvoir OpenMOLE en tant que tel 
...
$\approx$ 1 month of workload (ventilated during the year before)  for 8-9 people, consumed in 5 days !
...
\textit{We need you if the zombies come back}
